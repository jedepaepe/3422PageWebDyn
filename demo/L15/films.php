    ...
    <head>
        ...
        <style>
            * {box-sizing: border-box;}
            ...
            .twoColumns > * {display: table-row;}
            .twoColumns > * > * {border: 1px solid black; display: table-cell; padding: 10px;}
            .twoColumns img {vertical-align: top; width: 200px;}
            .twoColumns h2 {font-size: 2em; margin-bottom: 10px;}
        </style>
    </head>
    <body>
        <header>
        ...
        <main>
            <div class="twoColumns">
                <article>
                    <div>
                        <img src="http://www.udel.edu/udaily/2013/nov/images/casablanca.jpg" alt="Affiche du film Casablanca"/>
                    </div>
                    <div>
                        <h2>Casablanca</h2>
                        <p>
